    ...
    <form>
        <div className="space-y-12">
            <div className="border-b pb-12">
                <h2 className="text-3xl font-semibold leading-7 text-gray-200 pl-8 pt-8">General Information </h2>
                ...
                <div className="border-b pb-12">
                <h2 className="text-3xl font-semibold leading-7 text-gray-200 pl-8">Company Details</h2>
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 pl-8">
                    ...
                    <div className="sm:col-span-1">
                    <label htmlFor="industry-type" className="block text-sm font-medium leading-6 text-gray-200 required">
                        Industry Type
                    </label>
                    <div className="mt-2">
                        <input
